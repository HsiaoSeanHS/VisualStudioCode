import numba, requests, numpy as np, pandas as pd
...
api_key = 'IkJjIdmSJ3CqGOYYY3L1HHPoqjyA8Z4FHBWDzSoTeuGLqKmPsIL0wBOLxiOJZZpI'
api_secret = 'phfSKDzFmKtRBUCY4VbiunIycAwBMvWYSGlostvqXjKhHtfUsZjFwN3KLb1xUyJE'
